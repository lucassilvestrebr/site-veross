...
(function () {
  ...
  // ── Meta Pixel ──
  (function() {
    if (/localhost|127\.0\.0\.1|claudeusercontent/.test(window.location.hostname)) return;
